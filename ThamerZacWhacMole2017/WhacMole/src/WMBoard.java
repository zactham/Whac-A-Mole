 ...
 
{
	...
	protected void paintComponent(Graphics page)
	{
		...
		page.setColor(colorG);
		page.fillRect(130, 0, length, width);
		page.setColor(color2);
		page.fillOval(142, 35, 75, 35); //+30
 
		page.setColor(colorG);
		page.fillRect(240, 0, length, width);
		page.setColor(color3);
		page.fillOval(262, 35, 75, 35); //+50
		...
		page.setColor(colorG);
		page.fillRect(140, 100, length, width);
		page.setColor(color5);
		page.fillOval(142, 135, 75, 35);
 
		page.setColor(colorG);
		page.fillRect(230, 100, length, width);
		page.setColor(color6);
		page.fillOval(262, 135, 75, 35);
		...
		page.setColor(colorG);
		page.fillRect(130, 200, length, width);
		page.setColor(color8);
		page.fillOval(142, 235, 75, 35);
 
		page.setColor(colorG);
		page.fillRect(230, 200, length, width);
		page.setColor(color9);
		page.fillOval(262, 235, 75, 35);
 
		page.setColor(Color.black);
		//Font font = new Font("", 0, 20);
		page.setFont(new Font("Comic Sans MS", Font.PLAIN, 50));
	//	 Font font = page.getFont().deriveFont( 50.0f );
	//	 page.setFont(font);
		...
		if (square2) 
		{
			...
			// body
			page.setColor(Color.orange.darker());
			page.fillOval(62 + 100, 10, 40, 60);
			// teeth
			page.setColor(Color.white);
			page.fillRect(77 + 100, 41, 5, 10);
			page.fillRect(83 + 100, 41, 5, 10);
			// nose
			page.setColor(Color.black);
			page.drawOval(75 + 100, 34, 7, 7);
			page.drawOval(82 + 100, 34, 7, 7);
			page.fillOval(78 + 100, 29, 9, 9);
			// eyes
			// left eye
			page.setColor(Color.black);
			page.drawOval(72 + 100, 20, 6, 10);
			page.setColor(Color.white);
			page.fillOval(72 + 100, 20, 6, 10);
			page.setColor(Color.black);
			page.fillOval(73 + 100, 23, 4, 4);
			// right eye
			page.setColor(Color.black);
			page.drawOval(87 + 100, 20, 6, 10);
			page.setColor(Color.white);
			page.fillOval(87 + 100, 20, 6, 10);
			page.setColor(Color.black);
			page.fillOval(88 + 100, 23, 4, 4);
			color2 = Color.black;
		}
		...
		if (square3)
		{
			...
			// body
			page.setColor(Color.orange.darker());
			page.fillOval(82 + 200, 10, 40, 60);
			// teeth
			page.setColor(Color.white);
			page.fillRect(97 + 200, 41, 5, 10);
			page.fillRect(103 + 200, 41, 5, 10);
			// nose
			page.setColor(Color.black);
			page.drawOval(95 + 200, 34, 7, 7);
			page.drawOval(102 + 200, 34, 7, 7);
			page.fillOval(98 + 200, 29, 9, 9);
			// eyes
			// left eye
			page.setColor(Color.black);
			page.drawOval(92 + 200, 20, 6, 10);
			page.setColor(Color.white);
			page.fillOval(92 + 200, 20, 6, 10);
			page.setColor(Color.black);
			page.fillOval(93 + 200, 23, 4, 4);
			// right eye
			page.setColor(Color.black);
			page.drawOval(107 + 200, 20, 6, 10);
			page.setColor(Color.white);
			page.fillOval(107 + 200, 20, 6, 10);
			page.setColor(Color.black);
			page.fillOval(108 + 200, 23, 4, 4);
			color3 = Color.black;
		}
		...
		if (square5) 
		{
			...
			// body
			page.setColor(Color.orange.darker());
			page.fillOval(62 + 100, 10 + 100, 40, 60);
			// teeth
			page.setColor(Color.white);
			page.fillRect(77 + 100, 41 + 100, 5, 10);
			page.fillRect(83 + 100, 41 + 100, 5, 10);
			// nose
			page.setColor(Color.black);
			page.drawOval(75 + 100, 34 + 100, 7, 7);
			page.drawOval(82 + 100, 34 + 100, 7, 7);
			page.fillOval(78 + 100, 29 + 100, 9, 9);
			// eyes
			// left eye
			page.setColor(Color.black);
			page.drawOval(72 + 100, 20 + 100, 6, 10);
			page.setColor(Color.white);
			page.fillOval(72 + 100, 20 + 100, 6, 10);
			page.setColor(Color.black);
			page.fillOval(73 + 100, 23 + 100, 4, 4);
			// right eye
			page.setColor(Color.black);
			page.drawOval(87 + 100, 20 + 100, 6, 10);
			page.setColor(Color.white);
			page.fillOval(87 + 100, 20 + 100, 6, 10);
			page.setColor(Color.black);
			page.fillOval(88 + 100, 23 + 100, 4, 4);
			color5 = Color.black;
		}
		...
		if (square6) 
		{
			...
			// body
			page.setColor(Color.orange.darker());
			page.fillOval(82 + 200, 10 + 100, 40, 60);// 42 -18
			// teeth
			page.setColor(Color.white);
			page.fillRect(97 + 200, 41 + 100, 5, 10);
			page.fillRect(103 + 200, 41 + 100, 5, 10);
			// nose
			page.setColor(Color.black);
			page.drawOval(95 + 200, 34 + 100, 7, 7);
			page.drawOval(102 + 200, 34 + 100, 7, 7);
			page.fillOval(98 + 200, 29 + 100, 9, 9);
			// eyes
			// left eye
			page.setColor(Color.black);
			page.drawOval(92 + 200, 20 + 100, 6, 10);
			page.setColor(Color.white);
			page.fillOval(92 + 200, 20 + 100, 6, 10);
			page.setColor(Color.black);
			page.fillOval(93 + 200, 23 + 100, 4, 4);
			// right eye
			page.setColor(Color.black);
			page.drawOval(107 + 200, 20 + 100, 6, 10);
			page.setColor(Color.white);
			page.fillOval(107 + 200, 20 + 100, 6, 10);
			page.setColor(Color.black);
			page.fillOval(108 + 200, 23 + 100, 4, 4);
			color6 = Color.black;
		}
		...
		if (square8) 
		{
			...
			// body
			page.setColor(Color.orange.darker());
			page.fillOval(62 + 100, 10 + 200, 40, 60);// 42 -18
			// teeth
			page.setColor(Color.white);
			page.fillRect(77 + 100, 41 + 200, 5, 10);
			page.fillRect(83 + 100, 41 + 200, 5, 10);
			// nose
			page.setColor(Color.black);
			page.drawOval(75 + 100, 34 + 200, 7, 7);
			page.drawOval(82 + 100, 34 + 200, 7, 7);
			page.fillOval(78 + 100, 29 + 200, 9, 9);
			// eyes
			// left eye
			page.setColor(Color.black);
			page.drawOval(72 + 100, 20 + 200, 6, 10);
			page.setColor(Color.white);
			page.fillOval(72 + 100, 20 + 200, 6, 10);
			page.setColor(Color.black);
			page.fillOval(73 + 100, 23 + 200, 4, 4);
			// right eye
			page.setColor(Color.black);
			page.drawOval(87 + 100, 20 + 200, 6, 10);
			page.setColor(Color.white);
			page.fillOval(87 + 100, 20 + 200, 6, 10);
			page.setColor(Color.black);
			page.fillOval(88 + 100, 23 + 200, 4, 4);
			color8 = Color.black;
		}
		...
		if (square9) 
		{
			...
			// body
			page.setColor(Color.orange.darker());
			page.fillOval(82 + 200, 10 + 200, 40, 60);// 42 -18
			// teeth
			page.setColor(Color.white);
			page.fillRect(97 + 200, 41 + 200, 5, 10);
			page.fillRect(103 + 200, 41 + 200, 5, 10);
			// nose
			page.setColor(Color.black);
			page.drawOval(95 + 200, 34 + 200, 7, 7);
			page.drawOval(102 + 200, 34 + 200, 7, 7);
			page.fillOval(98 + 200, 29 + 200, 9, 9);
			// eyes
			// left eye
			page.setColor(Color.black);
			page.drawOval(92 + 200, 20 + 200, 6, 10);
			page.setColor(Color.white);
			page.fillOval(92 + 200, 20 + 200, 6, 10);
			page.setColor(Color.black);
			page.fillOval(93 + 200, 23 + 200, 4, 4);
			// right eye
			page.setColor(Color.black);
			page.drawOval(107 + 200, 20 + 200, 6, 10);
			page.setColor(Color.white);
			page.fillOval(107 + 200, 20 + 200, 6, 10);
			page.setColor(Color.black);
			page.fillOval(108 + 200, 23 + 200, 4, 4);
			color9 = Color.black;
		}
